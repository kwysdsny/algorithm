...
FROM Activity a
         JOIN Activity b
              on
                  ...
                  a.process_id=b.process_id and a.activity_type="end" and b.activity_type="start" group by a.machine_id
...
select name,bonus from Employee e left join bonus b on e.empid=b.empid where b.bonus<1000 or isnull(bonus)
